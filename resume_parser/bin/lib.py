...
def term_count(string_to_search, term):
    ...
    try:
        ...
        logging.error('termcount_Error occurred during regex search: {}'.format(exception_instance))
        return 0
...
def term_match(string_to_search, term):
    ...
    try:
        ...
        logging.error('termmatch_Error occurred during regex search: {}'.format(exception_instance))
        return None
